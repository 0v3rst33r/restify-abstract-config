...
class AbstractAPI {
     ...
     */
    addGet(url, impl) {
        this._addEndpoint(HttpMethod.GET, new Endpoint(HttpMethod.GET, url, impl));
    }
     ...
     */
    addPut(url, impl) {
        this._addEndpoint(HttpMethod.PUT, new Endpoint(HttpMethod.PUT, url, impl));
    }
     ...
     */
    addDelete(url, impl) {
        this._addEndpoint(HttpMethod.DELETE, new Endpoint(HttpMethod.DELETE, url, impl));
    }
     ...
     */
    addPost(url, impl) {
        this._addEndpoint(HttpMethod.POST, new Endpoint(HttpMethod.POST, url, impl));
    }
